...
class Hubungi extends CI_Controller {
  ...
  public function index()
  {
    ...
    $data['content'] = 'hubungi/index';
    $data['js']      = 'hubungi/hubungi_vitamin';
    $table           = 'bukutamu';
    $limit           = null;
    $offset          = null;
    $where           = null;
    ...
    $config['base_url']           = site_url('admin/hubungi/index');
    ...
    $data['arr_bukutamu'] = $this->mdb->get($table, $config['per_page'], $from, $where, $order, $order_ori);
